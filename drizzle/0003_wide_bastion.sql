...
--> statement-breakpoint
ALTER TABLE "ChallengeOptions" ADD CONSTRAINT "ChallengeOptions_challenge_id_lessons_id_fk" FOREIGN KEY ("challenge_id") REFERENCES "public"."lessons"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "challengeProgress" ADD CONSTRAINT "challengeProgress_challenge_id_lessons_id_fk" FOREIGN KEY ("challenge_id") REFERENCES "public"."lessons"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
